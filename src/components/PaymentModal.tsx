    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (result.helpText) {
          ...
          setError('PayPal is currently unavailable. Please use credit card payment instead.');
        }
        return;
      }
      ...
      setError('PayPal payment failed. Please try credit card payment instead.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <div className="text-3xl font-bold text-white mt-4">${amount.toFixed(2)}</div>
        </div>
