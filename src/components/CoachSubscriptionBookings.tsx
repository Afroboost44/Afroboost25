    ...
    <Card className={className}>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h2 className="text-xl sm:text-2xl font-semibold">Subscription Management</h2>
        ...
        {activeTab === 'sessions' && (
          <div className="space-y-4">
            <div className="bg-blue-500/20 border border-blue-500 rounded-lg p-4">
              <h3 className="font-medium text-blue-400 mb-2">Session Management</h3>
              <p className="text-sm text-gray-300">
                Manage sessions booked through subscriptions. Mark sessions as attended or missed to update student records.
              </p>
            </div>
            ...
            {sessionUsages.length > 0 ? (
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs sm:text-sm text-gray-400">
                                Student: {usage.userId.slice(0, 8)}...
                              </p>
                            </div>
                          </div>
                        ...
                        {usage.status === 'scheduled' && (
                          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                            ...
                            >
                              ...
                              <span className="hidden sm:inline">Mark Attended</span>
              ...
              <div className="bg-gray-800/50 p-8 rounded-lg text-center">
                ...
                <p className="text-gray-400">No subscription sessions found</p>
                <p className="text-sm text-gray-500 mt-1">
                  Sessions booked through subscriptions will appear here
                </p>
              </div>
            )}
          </div>
        ...
        {activeTab === 'subscribers' && (
          <div className="space-y-4">
            <div className="bg-green-500/20 border border-green-500 rounded-lg p-4">
              <h3 className="font-medium text-green-400 mb-2">Your Subscribers</h3>
              <p className="text-sm text-gray-300">
                View students who have active subscriptions and have attended your sessions.
              </p>
            </div>
            ...
            {subscribers.length > 0 ? (
                        ...
                        <div className="text-sm">
                          ...
                          {subscriber.subscription.planType === 'session_pack' && (
                            <p className="text-gray-400">
                              {subscriber.subscription.remainingSessions || 0} sessions remaining
                            </p>
                          )}
                        </div>
                        
                        <div className="text-sm text-right">
                          <p className="text-gray-400">Sessions with you</p>
              ...
              <div className="bg-gray-800/50 p-8 rounded-lg text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Students with active subscriptions will appear here
                </p>
              </div>
            )}
          </div>
