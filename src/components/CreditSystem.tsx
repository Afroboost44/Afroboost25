  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        {/* Custom Amount */}
        <div className="border-t border-[#D91CD2]/20 pt-6">
          <h4 className="font-medium mb-4">Custom Amount</h4>
          <div className="flex space-x-3">
            <div className="flex-1 relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
                <FiDollarSign className="text-gray-400" />
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Book classes instantly without entering payment details every time</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium">Secure & Convenient</h4>
              <p className="text-gray-400 text-sm">Your credits are safely stored and never expire</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium">Referral Bonuses</h4>
              <p className="text-gray-400 text-sm">Earn $5 credits for every friend you refer who completes a class</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <StripePaymentModal
        ...
        amount={selectedAmount}
        title="Add Credits"
        description="Top up your account with credits to book classes"
        userId={user.id}
      />
    </div>
  );
