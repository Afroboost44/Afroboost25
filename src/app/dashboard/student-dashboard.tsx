...
import { FiCalendar, FiClock, FiMessageCircle, FiTrendingUp, FiBell, FiChevronRight, FiPackage, FiUser, FiDollarSign, FiUsers } from 'react-icons/fi';
...
import Link from 'next/link';
import { motion } from 'framer-motion';
import { FiCalendar, FiClock, FiMessageCircle, FiTrendingUp, FiBell, FiChevronRight, FiPackage, FiUser } from 'react-icons/fi';
        ...
        <Card className="sticky top-24">
          ...
          <nav className="space-y-2">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
                activeTab === 'session-overview' ? 'bg-[#D91CD2]/20 text-[#D91CD2]' : 'hover:bg-black/40'
              }`}
            >
              ...
              <Card>
                ...
                <div className="space-y-4">
                  {upcomingSessions.length > 0 ? (
                    upcomingSessions
                      ...
                      .map(booking => (
                        <div key={booking.id} className="bg-black/40 p-4 rounded-lg flex justify-between items-center">
                          ...
                          <Link href={`/booking/${booking.id}`} className="text-[#D91CD2] hover:underline flex items-center">
                    ...
                    <div className="bg-black/40 p-8 rounded-lg text-center">
                      <p className="text-gray-400">No upcoming sessions. Book a new session!</p>
                    </div>
                  )}
                </div>
              </Card>
        ...
        {activeTab === 'chat' && (
          ...
          >
            <motion.div variants={item}>
              <Card>
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold">{t.communityChat}</h2>
                </div>
                
                <div className="bg-black/40 p-8 rounded-lg text-center">
                  <FiMessageCircle className="mx-auto text-4xl text-gray-500 mb-3" />
                  <p className="text-gray-400 mb-4">Connect with other dancers and share your experience!</p>
                  <Link href="/chat" className="btn-primary">
                    Open Chat
                  </Link>
                </div>
            ...
            <motion.div variants={item}>
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-black/40 p-4 rounded-lg">
                    <h3 className="font-medium mb-4">Dance Skills</h3>
                    <p className="text-gray-400 text-center">Complete more sessions to track your progress!</p>
                  </div>
                </div>
              </Card>
            </motion.div>
