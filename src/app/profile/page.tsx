          ...
          <Card>
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-900 p-4 rounded-lg mb-4">
                <p className="text-sm mb-2">{t.shareReferral}</p>
                <div className="flex items-center mb-3">
                  <input
                    type="text"
                    value={user.referralCode}
                    readOnly
                    className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-sm flex-1 mr-2"
                  />
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(user.referralCode);
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-400">{t.totalEarnings}</span>
                  <span className="font-semibold text-[#D91CD2]">${user.credits || 0}</span>
                </div>
              </div>
            </div>
